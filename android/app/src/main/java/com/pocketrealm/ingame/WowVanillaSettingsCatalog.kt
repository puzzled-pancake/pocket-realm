...
object WowVanillaSettingsCatalog {
    ...
    private val definitions: List<WowSettingDefinition> = listOf(
        ...
        WowSettingDefinition(
            ...
            label = "Multisampling", control = WowSettingControl.CHOICE,
            backend = WowSettingBackend.CVAR, key = "gxMultisample",
            choices = listOf(
                WowSettingChoice("0", "Off", "0"),
                WowSettingChoice("1", "1x", "1"),
                WowSettingChoice("2", "2x", "2"),
                WowSettingChoice("4", "4x", "4"),
            ),
            defaultValue = "1", provenance = WowSettingProvenance.DEVICE_CAPTURE,
        ...
        WowSettingDefinition(
            ...
            choices = listOf(
                WowSettingChoice("16", "16 bit", "16"),
                WowSettingChoice("24", "24 bit", "24"),
            ),
        ...
        WowSettingDefinition(
            ...
            defaultProvenance = WowSettingProvenance.DEVICE_CAPTURE,
            fixedReason = "The panel is 60 Hz",
        ),
        WowSettingDefinition(
