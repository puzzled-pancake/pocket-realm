...
inline char const* const* MurmurFloorTable(size_t& count)
{
    static char const* const templates[] = {
        ...
        "{E}, {L}. The word travels fast.",
        "{L} - {E}. I heard it from a mule trader.",
        "{E}. That is the talk, {L}.",
        "Just between us, {L}: {E}.",
        "{E}, {L}. Keep it under your hood.",
        "The whole road says {E}, {L}.",
        "{L}, did you catch it? {E}.",
        "{E}. A trader swore it, {L}.",
        "Quietly now, {L}, listen: {E}.",
        "{E}, {L}. Mark my words.",
        "{L}. {E}. Small thing, big talk.",
        "News runs fast, {L}: {E}.",
        "{E}, {L}. Nobody believes it yet.",
        "They whisper {E} down at the ford, {L}.",
        "{L}, the peddler says {E}.",
        "{E}. You heard it here, {L}.",
        "{L}, the mill has it: {E}.",
        "{E}, {L}. Take it or leave it.",
        "Straight fireside talk, {L}: {E}.",
        "{E}, {L}. That is the story going round.",
        "{L}, a shepherd swore {E}.",
        "{E}. The inn agrees, {L}.",
        "{L}! {E}. Just imagine that.",
        "{E}, {L}. Coins on it being true.",
        "{L}, the guard mutters {E}.",
        "{E}, {L}. Three sources, no sense.",
        "{L}, the wind carried {E}.",
        "{E}, {L}. Even the birds repeat it.",
        "{L}, the ferryman claims {E}.",
        "{E}. Pass it along, {L}.",
        "{L}, someone said {E}. Loudly.",
        "{E}, {L}. Truth or tail, it walks.",
        "{L}, the tinker insists {E}.",
        "{E}, {L}. New to me too.",
        "{L}. {E}. Fold that into your day.",
        "{E}, {L}. Half the town already.",
        "{L}, the hunter swears {E}.",
        "{E}, {L}. Keep the sour look, it fits.",
        "{L}, hear this one: {E}.",
        "{E}, {L}. Good gossip ages fast.",
        "{L}, the baker's boy tells {E}.",
        "{E}, {L}. One copper says true.",
        "{L}, an old soldier muttered {E}.",
        "{E}, {L}. That is the dust settling.",
        "{L}, the stable talk is {E}.",
        "{E}, {L}. Believe a third of it.",
        "{L}, the churchyard says {E}.",
        "{E}, {L}. Fresh off the road.",
        "{L}, the well keeps saying {E}.",
        "{E}, {L}. You did not hear it from me.",
        "{L}, a drunk miner claimed {E}.",
        "{E}, {L}. The road talks tonight.",
        "{L}, the fisherwives have {E}.",
        "{E}, {L}. Spread it gently.",
        "{L}, the night watch passed {E}.",
        "{E}, {L}. So the story runs.",
        "{L}, the children chant {E}.",
        "{E}, {L}. Facts optional, they say.",
        "{L}, a courier let slip {E}.",
        "{E}, {L}. The tavern stands behind it.",
        "{L}, the herbalist murmured {E}.",
        "{E}, {L}. Decide for yourself.",
        "{L}, the farrier repeats {E}.",
        "{E}, {L}. News like rain, everywhere.",
        "{L}, the choir gossips {E}.",
        "{E}, {L}. One ear, one copper.",
        "{L}, the rat catcher knows {E}.",
        "{E}, {L}. Trust the river, not the source.",
        "{L}, the camp follows {E}.",
        "{E}, {L}. Rumor with boots on.",
        "{L}, the smithy hums with {E}.",
        "{E}, {L}. Secondhand, but solid.",
        "{L}, the drover hollered {E}.",
        "{E}, {L}. The night agrees.",
        "{L}, an old wife planted {E}.",
        "{E}, {L}. The kind that sticks.",
        "{L}, the harbor repeats {E}.",
        "{E}, {L}. Coin says twice true.",
        "{L}, the midwife delivered {E}.",
        "{E}, {L}. Cold hearth, warm talk.",
        "{L}, the scout reported {E}.",
        "{E}, {L}. Nothing stays quiet here.",
        "{L}, the cooper barrelled up {E}.",
        "{E}, {L}. The hills have ears and mouths.",
        "{L}, the tailor stitched {E}.",
        "{E}, {L}. Wear it lightly.",
        "{L}, the rat catchers trade {E}.",
        "{E}, {L}. The dust knows first.",
        "{L}, the innkeeper pours {E}.",
        "{E}, {L}. On the house.",
        "{L}, the gate guard waved in {E}.",
        "{E}, {L}. Through the gate, into the street.",
        "{L}, the road brings {E}.",
        "{E}, {L}. Walk it slower than it ran.",
        "{L}, the market bell rang with {E}.",
        "{E}, {L}. Priced to move.",
        "{L}, the beggars pass {E}.",
        "{E}, {L}. Rich talk for poor pockets.",
        "{L}, the tower watch lit on {E}.",
        "{E}, {L}. Seen from above, told below.",
        "{L}, the night soil men know {E}.",
        "{E}, {L}. Where nothing stays buried.",
        "{L}, the dogs barked up {E}.",
        "{E}, {L}. Even the fleas talk.",
        "{L}, the rain carried {E}.",
        "{E}, {L}. Wet news dries fast.",
        "{L}, the chimney smoke spelled {E}.",
        "{E}, {L}. Read it and forget it.",
        "{L}, the gravedigger filed {E}.",
        "{E}, {L}. Filed where everything ends up.",
    };
