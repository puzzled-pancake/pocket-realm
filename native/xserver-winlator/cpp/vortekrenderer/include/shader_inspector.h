...
typedef struct ShaderInspector {
    bool passthrough;            /* validated SPIR-V is created directly; no custom parser */
...
extern bool ShaderInspector_validateSpirvEnvelope(const uint32_t* code, size_t codeSize);
